package com.junyou.bus.zuoqi.entity;
...
@Table("zuo_qi_info")
public class ZuoQiInfo extends AbsVersion implements Serializable,IEntity {
	...
	public ZuoQiInfo copy(){
		ZuoQiInfo result = new ZuoQiInfo();
