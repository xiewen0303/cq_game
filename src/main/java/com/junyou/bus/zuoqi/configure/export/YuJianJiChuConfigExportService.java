 ...
 */
@Component
public class YuJianJiChuConfigExportService extends AbsClasspathConfigureParser  {
	...
	private Map<Integer,YuJianJiChuConfig> configs = null;
	...
	/**
	  * configFileName
	 */
//	private String configureName = "YuJianJiChuBiao.jat";
	private String configureName = "YuJianFenXingBiao.jat";
	...
	protected void configureDataResolve(byte[] data) {
		...
		configs = new HashMap<Integer, YuJianJiChuConfig>();
		maxConfigId = 0;
		...
		for (Object obj : dataList) {
			...
			if (null != tmp) {
				YuJianJiChuConfig config = createYuJianJiChuConfig(tmp);
	...
	public YuJianJiChuConfig createYuJianJiChuConfig(Map<String, Object> tmp) {
		YuJianJiChuConfig config = new YuJianJiChuConfig();	
	...
	public YuJianJiChuConfig loadById(int id){
