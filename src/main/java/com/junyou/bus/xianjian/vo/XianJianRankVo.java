package com.junyou.bus.xianjian.vo;
...
public class XianJianRankVo extends BaseRank implements Serializable , IEntity,IXianJianRankVo{
	...
	@Override
	public IEntity copy() {
		XianJianRankVo copy=new XianJianRankVo();
