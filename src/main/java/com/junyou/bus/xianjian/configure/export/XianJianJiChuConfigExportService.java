 ...
 */
@Component
public class XianJianJiChuConfigExportService extends AbsClasspathConfigureParser  {
	...
	private Map<Integer,XianJianJiChuConfig> configs = null;
	
	/**
	  * configFileName
	 */
//	private String configureName = "XianJianJiChuBiao.jat";
	private String configureName = "XianJianFenXingBiao.jat";
	...
	protected void configureDataResolve(byte[] data) {
		...
		configs = new HashMap<Integer, XianJianJiChuConfig>();
		maxConfigId = 0;
		...
		for (Object obj : dataList) {
			...
			if (null != tmp) {
				XianJianJiChuConfig config = createYuJianJiChuConfig(tmp);
	...
	public XianJianJiChuConfig createYuJianJiChuConfig(Map<String, Object> tmp) {
		XianJianJiChuConfig config = new XianJianJiChuConfig();	
...
//		config.setGgid(CovertObjectUtil.obj2StrOrNull(tmp.get("ggid")));
	...
	public XianJianJiChuConfig loadById(int id){
