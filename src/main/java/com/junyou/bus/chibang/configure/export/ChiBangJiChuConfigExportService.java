 ...
 */
@Component
public class ChiBangJiChuConfigExportService extends AbsClasspathConfigureParser  {
	...
	private Map<Integer,ChiBangJiChuConfig> configs = null;
	...
	/**
	  * configFileName
	 */
//	private String configureName = "ChiBangJiChuBiao.jat";
	private String configureName = "ChiBangFenXingBiao.jat";
	...
	protected void configureDataResolve(byte[] data) {
		...
		Map<Integer,ChiBangJiChuConfig>	configsTemp = new HashMap<Integer, ChiBangJiChuConfig>();
		maxConfigId = 0;
		...
		for (Object obj : dataList) {
			...
			if (null != tmp) {
				ChiBangJiChuConfig config = createYuJianJiChuConfig(tmp);
				if(czdId == null){
	...
	public ChiBangJiChuConfig createYuJianJiChuConfig(Map<String, Object> tmp) {
		ChiBangJiChuConfig config = new ChiBangJiChuConfig();	
...
//		config.setMoveAttrVal(moveAttrVal);
	...
	public ChiBangJiChuConfig loadById(int id){
