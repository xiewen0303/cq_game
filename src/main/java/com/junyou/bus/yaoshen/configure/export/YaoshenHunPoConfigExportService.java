 ...
 */
@Component
public class YaoshenHunPoConfigExportService extends
	 ...
	 * configFileName
	 */
	private String configureName = "YaoShenHunPo.jat";
	...
	private YaoshenJichuConfig createHunPoPeiZhiConfig(
	...
	protected void configureDataResolve(byte[] data) {
		...
		for (Object obj : dataList) {
			...
			if (null != tmp) {
				YaoshenJichuConfig config = createHunPoPeiZhiConfig(tmp);
...
//		attrMap = tmpAttrMap;
	...
	public Map<String, Long> getYaoshenHunpoAttribute(int jie, int ceng) {
