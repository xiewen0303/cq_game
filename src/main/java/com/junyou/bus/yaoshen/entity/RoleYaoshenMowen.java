...
@Table("role_yaoshen_mowen")
public class RoleYaoshenMowen extends AbsVersion implements Serializable,IEntity {
	...
	public RoleYaoshenMowen copy(){
		RoleYaoshenMowen result = new RoleYaoshenMowen();
