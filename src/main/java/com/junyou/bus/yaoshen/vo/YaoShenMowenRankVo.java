...
public class YaoShenMowenRankVo extends BaseRank implements Serializable , IEntity,IYaoShenMowenRankVo{
	...
	public Integer getMowenLevel() {
		return mowenLevel;
	}
	public void setMowenLevel(Integer mowenLevel) {
		this.mowenLevel = mowenLevel;
	}
	...
	@Override
	public IEntity copy() {
		YaoShenMowenRankVo copy=new YaoShenMowenRankVo();
		copy.setUserRoleId(getUserRoleId());
		copy.setRank(getRank());
		copy.setName(getName());
		copy.setConfigId(getConfigId());
		copy.setMowenLevel(getYaoshenMowenLevel());
	...
	@Override
	public Integer getYaoshenMowenLevel() {
		return mowenLevel;
	}

	@Override
	public String getUncertain() {
		return  getYaoshenMowenLevel().toString()+","+getCengLevel();
	}
