 ...
 */
public class MoreFubenSourceTeam {
	// 队伍ID
	private int teamId;
	// 成员列表list
	...
	public MoreFubenSourceTeam(Integer teamId,Integer fubenId) {
		this.teamId = teamId;
	...
	public Object[] getMsg() {
		...
		nextTime = GameSystemTime.getSystemMillTime() + GameConstants.MORE_FUBEN_YAOQING_INTERVAL;
		if(msg == null){
