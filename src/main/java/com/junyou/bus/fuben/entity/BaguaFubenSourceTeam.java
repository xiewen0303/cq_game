 ...
 */
public class BaguaFubenSourceTeam {
	// 队伍ID
	private int teamId;
	// 成员列表list
	...
	public BaguaFubenSourceTeam(Integer teamId,Integer fubenId) {
		this.teamId = teamId;
	...
	public Object[] getMsg() {
		...
		nextTime = GameSystemTime.getSystemMillTime() + GameConstants.BAGUA_FUBEN_YAOQING_INTERVAL;
		if(msg == null){
