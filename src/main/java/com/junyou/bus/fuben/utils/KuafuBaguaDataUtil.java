 ...
 * 2015-5-23 下午1:34:35
 */
public class KuafuBaguaDataUtil {
	...
	public static String getRedisServerKey(){
		return "bf_teams_server_"+ChuanQiConfigUtil.getServerId();
	}
