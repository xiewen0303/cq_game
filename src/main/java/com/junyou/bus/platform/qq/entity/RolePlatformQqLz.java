...
public class RolePlatformQqLz extends AbsVersion implements Serializable,IEntity {
	...
	public RolePlatformQqLz copy(){
		RolePlatformQqLz result = new RolePlatformQqLz();
