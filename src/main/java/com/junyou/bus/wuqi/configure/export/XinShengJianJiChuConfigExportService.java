 ...
 */
@Component
public class XinShengJianJiChuConfigExportService extends AbsClasspathConfigureParser  {
	...
	private Map<Integer,XinShengJianJiChuConfig> configs = null;
	...
	/**
	  * configFileName
	 */
//	private String configureName = "XinShengJianJiChuBiao.jat";
	private String configureName = "XinShengJianFenXingBiao.jat";
	...
	protected void configureDataResolve(byte[] data) {
		...
		configs = new HashMap<Integer, XinShengJianJiChuConfig>();
		maxConfigId = 0;
		...
		for (Object obj : dataList) {
			...
			if (null != tmp) {
				XinShengJianJiChuConfig config = createYuJianJiChuConfig(tmp);
	...
	public XinShengJianJiChuConfig createYuJianJiChuConfig(Map<String, Object> tmp) {
		XinShengJianJiChuConfig config = new XinShengJianJiChuConfig();	
...
//		long moveAttrVal = attrs.remove(EffectType.x20.name());
//		config.setMoveAttrVal(moveAttrVal);
	...
	public XinShengJianJiChuConfig loadById(int id){
	...
	public int getTempZfz() {
		return tempZfz;
	}

	public void setTempZfz(int tempZfz) {
		this.tempZfz = tempZfz;
	}
}