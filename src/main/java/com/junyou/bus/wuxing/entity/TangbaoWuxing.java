...
@Table("tangbao_wuxing")
public class TangbaoWuxing extends AbsVersion implements Serializable, IEntity {
    ...
    public TangbaoWuxing copy() {
        TangbaoWuxing result = new TangbaoWuxing();
        result.setId(getId());
