...
@Table("tangbao_wuxing_skill")
public class TangbaoWuxingSkill extends AbsVersion implements Serializable, IEntity {
    ...
    public TangbaoWuxingSkill copy() {
        TangbaoWuxingSkill result = new TangbaoWuxingSkill();
        result.setId(getId());
    ...
    /**
     * @Description 获取糖宝所学习的技能编号集合
     * @return
     */
    public List<Integer> findTbWxSkillIds() {
