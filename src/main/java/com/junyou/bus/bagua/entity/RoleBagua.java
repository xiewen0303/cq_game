package com.junyou.bus.bagua.entity;
...
@Table("role_bagua")
public class RoleBagua extends AbsVersion implements Serializable,IEntity {
	...
	public RoleBagua copy(){
		RoleBagua result = new RoleBagua();
		result.setId(getId());
