package com.junyou.bus.zhanjia.entity;
...
@Table("zhan_jia_info")
public class ZhanJiaInfo extends AbsVersion implements Serializable,IEntity {
	...
	public ZhanJiaInfo copy(){
		ZhanJiaInfo result = new ZhanJiaInfo();
