 ...
 */
public class KaiFuYuJianFeiXianGroupConfig {
	
	private Map<Integer, KaiFuYuJianFeiXianConfig> configMap = new HashMap<>();
	private String des;//活动描述
	private String pic;//活动底图
	private String des1;
	
	private List<Object[]> jdData = new ArrayList<>();
	private List<Object[]> pxData = new ArrayList<>();
	private List<Object[]> tzData = new ArrayList<>();
	
	public List<Object[]> getJdData() {
		return jdData;
	}

	public void setJdData(List<Object[]> jdData) {
		this.jdData = jdData;
	}
	...
	public Map<Integer, KaiFuYuJianFeiXianConfig> getConfigMap() {
		return configMap;
	}

	public void setConfigMap(Map<Integer, KaiFuYuJianFeiXianConfig> configMap) {
