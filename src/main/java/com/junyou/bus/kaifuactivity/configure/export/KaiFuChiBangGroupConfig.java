 ...
 */
public class KaiFuChiBangGroupConfig {
	
	private Map<Integer, KaiFuChiBangConfig> configMap = new HashMap<>();
	...
	public Map<Integer, KaiFuChiBangConfig> getConfigMap() {
		return configMap;
	}

	public void setConfigMap(Map<Integer, KaiFuChiBangConfig> configMap) {
