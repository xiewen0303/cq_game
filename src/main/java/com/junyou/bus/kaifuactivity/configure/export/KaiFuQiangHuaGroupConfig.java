 ...
 */
public class KaiFuQiangHuaGroupConfig {
	
	private Map<Integer, KaiFuQiangHuaConfig> configMap = new HashMap<>();
	...
	public Map<Integer, KaiFuQiangHuaConfig> getConfigMap() {
		return configMap;
	}

	public void setConfigMap(Map<Integer, KaiFuQiangHuaConfig> configMap) {
