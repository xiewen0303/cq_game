...
public class KaiFuYaoMoConfig {
	...
	public Integer getYaomoLevel() {
		return yaomoLevel;
	}

	public void setyaomoLevel(Integer yaomoLevel) {
		this.yaomoLevel = yaomoLevel;
	}
