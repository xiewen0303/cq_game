 ...
 */
public class KaiFuQiLingGroupConfig {
	
	private Map<Integer, KaiFuQiLingConfig> configMap = new HashMap<>();
	...
	public Map<Integer, KaiFuQiLingConfig> getConfigMap() {
		return configMap;
	}

	public void setConfigMap(Map<Integer, KaiFuQiLingConfig> configMap) {
