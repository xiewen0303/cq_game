 ...
 */
public class KaiFuTangBaoXinWenConfig {
	...
	private Integer min;
	private Integer max;
	private Integer tangBaoXinWenLevel;
	...
	public Integer getTangBaoXinWenLevel() {
		return tangBaoXinWenLevel;
	}

	public void setTangBaoXinWenLevel(Integer tangBaoXinWenLevel) {
		this.tangBaoXinWenLevel = tangBaoXinWenLevel;
	}
