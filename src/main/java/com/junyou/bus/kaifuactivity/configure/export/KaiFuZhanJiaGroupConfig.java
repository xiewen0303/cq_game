 ...
 */
public class KaiFuZhanJiaGroupConfig {
	
	private Map<Integer, KaiFuZhanJiaConfig> configMap = new HashMap<>();
	...
	public Map<Integer, KaiFuZhanJiaConfig> getConfigMap() {
		return configMap;
	}

	public void setConfigMap(Map<Integer, KaiFuZhanJiaConfig> configMap) {
