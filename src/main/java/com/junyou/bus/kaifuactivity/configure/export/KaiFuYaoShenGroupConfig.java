 ...
 */
public class KaiFuYaoShenGroupConfig {
	
	private Map<Integer, KaiFuYaoShenConfig> configMap = new HashMap<>();
	...
	public Map<Integer, KaiFuYaoShenConfig> getConfigMap() {
		return configMap;
	}

	public void setConfigMap(Map<Integer, KaiFuYaoShenConfig> configMap) {
