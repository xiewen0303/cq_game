 ...
 */
public class KaiFuYaoMoGroupConfig {
	
	private Map<Integer, KaiFuYaoMoConfig> configMap = new HashMap<>();
	...
	public Map<Integer, KaiFuYaoMoConfig> getConfigMap() {
		return configMap;
	}

	public void setConfigMap(Map<Integer, KaiFuYaoMoConfig> configMap) {
