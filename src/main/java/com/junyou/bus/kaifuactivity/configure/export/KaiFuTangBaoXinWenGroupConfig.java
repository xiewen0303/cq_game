 ...
 */
public class KaiFuTangBaoXinWenGroupConfig {
	
	private Map<Integer, KaiFuTangBaoXinWenConfig> configMap = new HashMap<>();
	...
	public Map<Integer, KaiFuTangBaoXinWenConfig> getConfigMap() {
		return configMap;
	}

	public void setConfigMap(Map<Integer, KaiFuTangBaoXinWenConfig> configMap) {
