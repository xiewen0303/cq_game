 ...
 * 武器阶排行 
 */
public class KaiFuWuQiGroupConfig {
	
	private Map<Integer, KaiFuWuQiConfig> configMap = new HashMap<>();
	...
	public Map<Integer, KaiFuWuQiConfig> getConfigMap() {
		return configMap;
	}

	public void setConfigMap(Map<Integer, KaiFuWuQiConfig> configMap) {
