 ...
 */
public class KaiFuZhanLiBiPinGroupConfig {
	
	private Map<Integer, KaiFuZhanLiBiPinConfig> configMap = new HashMap<>();
	...
	public Map<Integer, KaiFuZhanLiBiPinConfig> getConfigMap() {
		return configMap;
	}

	public void setConfigMap(Map<Integer, KaiFuZhanLiBiPinConfig> configMap) {
