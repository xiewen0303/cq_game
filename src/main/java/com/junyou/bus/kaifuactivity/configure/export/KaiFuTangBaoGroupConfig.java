 ...
 */
public class KaiFuTangBaoGroupConfig {
	
	private Map<Integer, KaiFuTangBaoConfig> configMap = new HashMap<>();
	...
	public Map<Integer, KaiFuTangBaoConfig> getConfigMap() {
		return configMap;
	}

	public void setConfigMap(Map<Integer, KaiFuTangBaoConfig> configMap) {
