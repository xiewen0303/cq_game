 ...
 */
public class KaiFuYaoShenMoYinGroupConfig {
	
	private Map<Integer, KaiFuYaoShenMoYinConfig> configMap = new HashMap<>();
	...
	public Map<Integer, KaiFuYaoShenMoYinConfig> getConfigMap() {
		return configMap;
	}

	public void setConfigMap(Map<Integer, KaiFuYaoShenMoYinConfig> configMap) {
