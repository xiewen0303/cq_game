...
/**
 * 
 * @description 七日开服活动配置表 (全身强化)
 *
 * @author ZHONGDIAN
 * @date 2013-12-12 11:43:48
 */
public class KaiFuQiangHuaConfig {
	...
	public Integer getQiangHuaLevel() {
		return qiangHuaLevel;
	}

	public void setQiangHuaLevel(Integer qiangHuaLevel) {
