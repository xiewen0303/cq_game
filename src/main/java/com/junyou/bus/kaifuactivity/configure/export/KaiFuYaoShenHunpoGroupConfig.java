 ...
 */
public class KaiFuYaoShenHunpoGroupConfig {
	
	private Map<Integer, KaiFuYaoShenHunpoConfig> configMap = new HashMap<>();
	...
	public Map<Integer, KaiFuYaoShenHunpoConfig> getConfigMap() {
		return configMap;
	}

	public void setConfigMap(Map<Integer, KaiFuYaoShenHunpoConfig> configMap) {
