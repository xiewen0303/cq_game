package com.junyou.bus.qiling.manage;
 ...
 */
public class QiLing implements Serializable{
	...
	private int qiLingLevel; //器灵阶段等级
	...
	public int getQiLingLevel() {
		return qiLingLevel;
	}

	public void setQiLingLevel(int qiLingLevel) {
